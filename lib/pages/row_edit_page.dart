...
class RowEditPage extends StatefulWidget {
  const RowEditPage({super.key});

  @override
  State<RowEditPage> createState() => _RowEditPageState();
}

class _RowEditPageState extends State<RowEditPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Horizontal Row Puzzle'),
        actions: [
          IconButton(
              ...
              child: Center(
                child: Padding(
                  ...
                  child: RepaintBoundary(
                    key: _repaintKey,
                    child: _buildRowPreview(provider),
                  ),
                ),
              ),
            ),
  ...
  void _showHelpDialog(BuildContext context) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        title: const Text('Row Puzzle Tips'),
        content: const Text(
          '• This layout arranges photos in a horizontal row.\n'
          '• Select 1-3 photos from the picker.\n'
